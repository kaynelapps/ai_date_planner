...
class _AtHomeSuggestionScreenState extends State<AtHomeSuggestionScreen> {
  ...
  Future<void> _loadAdvice() async {
    try {
      ...
      final advice = await _geminiService.getAtHomeDateAdvice(widget.suggestion, locale);
      setState(() {
        _advice = advice;
        _isLoading = false;
      });
      ...
      setState(() {
        _advice = AppLocalizations.of(context)!.loadingError;
        _isLoading = false;
      });
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppLocalizations.of(context)!.atHomeDateTitle,
  ...
  Widget _buildFormattedAdvice() {
    ...
    final sectionTitles = [
      AppLocalizations.of(context)!.sectionIntroduction,
      AppLocalizations.of(context)!.sectionStepGuide,
      AppLocalizations.of(context)!.sectionAccommodation,
      AppLocalizations.of(context)!.sectionSpecialTouches,
      AppLocalizations.of(context)!.sectionConversationTips,
      AppLocalizations.of(context)!.sectionPreparation,
      AppLocalizations.of(context)!.sectionAdaptation,
    ];
