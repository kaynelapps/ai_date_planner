...
class ChristmasDateDetailScreen extends StatefulWidget {
  final ChristmasDateIdea dateIdea;

  const ChristmasDateDetailScreen({required this.dateIdea});

  @override
  _ChristmasDateDetailScreenState createState() => _ChristmasDateDetailScreenState();
}

class _ChristmasDateDetailScreenState extends State<ChristmasDateDetailScreen> {
