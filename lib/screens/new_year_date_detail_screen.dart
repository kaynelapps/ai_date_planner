...
class NewYearDateDetailScreen extends StatefulWidget {
  final NewYearDateIdea dateIdea;

  const NewYearDateDetailScreen({required this.dateIdea});

  @override
  _NewYearDateDetailScreenState createState() => _NewYearDateDetailScreenState();
}

class _NewYearDateDetailScreenState extends State<NewYearDateDetailScreen> {
