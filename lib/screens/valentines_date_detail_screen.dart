...
class ValentinesDateDetailScreen extends StatefulWidget {
  final ValentinesDateIdea dateIdea;

  const ValentinesDateDetailScreen({required this.dateIdea});

  @override
  _ValentinesDateDetailScreenState createState() => _ValentinesDateDetailScreenState();
}

class _ValentinesDateDetailScreenState extends State<ValentinesDateDetailScreen> {
